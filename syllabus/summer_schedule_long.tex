...
\subsubsection{Week 1 (5/13-): Why visualization?} %{{{
...
%}}}
\subsubsection{Week 2 (5/20-): History and integrity}%{{{
...
%}}}
\subsubsection{Week 3 (5/27-): Perception}%{{{
...
\end{itemize}	
%}}}
\subsubsection{Week 4 (6/3-): Design }%{{{ 
