...
\subsubsection{Why visualization?} %{{{
...
%}}}
\subsubsection{History and integrity}%{{{
...
\end{itemize}	
%}}}
\subsubsection{Data Types and 1-D data } %{{{
...
\end{itemize}	
%}}}
\subsubsection{Histogram and Boxplot }%{{{
...
\end{itemize}	
%}}}
\subsubsection{Estimation and logscale }%{{{
...
\end{itemize}	
%}}}
\subsubsection{Text and Networks } %{{{
