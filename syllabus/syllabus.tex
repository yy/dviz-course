...
\def\mytitle{{\normalsize INFO 422 / INFO 590 / DSCI 590} \\ \HUGE{} Data Visualization}
...
\published{\sffamily Fall 2023} 

\maketitle 

\vspace{-20pt}{Assistant Instructors and office hours: see Canvas} 
...
\begin{itemize}%{{{
\item Project proposal due: \textbf{09/29}
\item Exam: 11/13 during the class time
\item (Residential) Project presentation: \textbf{12/4} and \textbf{12/6} 
\item Project presentation and final paper due: \textbf{12/08}
\end{itemize} %}}}
