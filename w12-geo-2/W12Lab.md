...
One important change is . [**`.projection()`**](https://github.com/mbostock/d3/wiki/Geo-Paths#path_projection) specifies the projection function used by the path generator. We use the [**`albersUsa`**](https://github.com/mbostock/d3/wiki/Geo-Projections#albersUsa) projection. For other projections, see [here](https://github.com/mbostock/d3/wiki/Geo-Projections). Change the values for [**`scale()`**](https://github.com/mbostock/d3/wiki/Geo-Projections#scale) and [**`translate()`**](https://github.com/mbostock/d3/wiki/Geo-Projections#translate) and think about what they mean.
